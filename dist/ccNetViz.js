...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ccNetViz = function ccNetViz(canvas, options) {
	  ...
	  var offset = 2.0 * nodeStyle.maxSize; //added offset for screenspace GSoC 17
	  ...
	  this.draw = function (silent) {
	    ...
	    _this.enableTouch(); //including the enable touch function
	  };
	  ...
	  var ImgTouchCanvas = function () {
	    function ImgTouchCanvas(options) {
	      _classCallCheck(this, ImgTouchCanvas);
	    ...
	    _createClass(ImgTouchCanvas, [{
	      ...
	      value: function animate() {
	        ...
	        this.context.drawImage(this.imgTexture, this.position.x, this.position.y, this.scale.x * this.imgTexture.width, this.scale.y * this.imgTexture.height);
	
	        requestAnimationFrame(this.animate.bind(this));
	      }
	    }, {
	      key: 'gesturePinchZoom',
	      value: function gesturePinchZoom(event) {
	        var zoom = false;
	      ...
	      key: 'doMove',
	      value: function doMove(relativeX, relativeY) {
	      ...
	      key: 'checkRequestAnimationFrame',
	      value: function checkRequestAnimationFrame() {
	        var lastTime = 0;
